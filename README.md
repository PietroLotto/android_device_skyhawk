...
# local manifest
mkdir .repo/local_manifests nano .repo/local_manifests/j7velte.xml

<?xml version="1.0" encoding="UTF-8"?>
<manifest>
  <project name="marchetto94/android_device_skyhawk" path="device/samsung/j7velte" remote="github" revision="j7velte" />
