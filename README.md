...
# local manifest
mkdir .repo/local_manifests nano .repo/local_manifests/on7xelte.xml

<?xml version="1.0" encoding="UTF-8"?>
<manifest>
  <project name="marchetto94/android_device_skyhawk" path="device/samsung/on7xelte" remote="github" revision="on7xelte" />
